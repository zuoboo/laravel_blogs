                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr class="text-xs text-gray-500 text-left">
                            ...
                            <th class="font-medium">お名前（フリガナ）</th>
                            <th class="font-medium">メールアドレス</th>
                            <th class="font-medium">お問い合わせ日時</th>
                    ...
                    <tbody>
                        @foreach ($contacts as $contact)
                            <tr class="text-sm bg-gray-50">
                                <td class="font-medium p-4">{{ $contact->name }}</td>
                                <td class="font-medium">{{ $contact->name_kana }}</td>
                                <td class="font-medium">{{ $contact->email }}</td>
                                <td>{{ $contact->created_at }}</td>
                                <td>
                                    <div class="flex">
                                    <a href="{{ route('admin.contacts.detail', ['contact' => $contact->id]) }}"
                                        class="mr-2">
